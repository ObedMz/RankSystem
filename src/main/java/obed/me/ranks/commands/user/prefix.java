...
public class prefix extends SubCommand {
        ...
        Database.TaskAsync(()->{
            ...
            if(p != null){
                plugin.getMessageComponent().sendMessageFromArray(sender,
                        plugin.getMessageComponent().getMessageArray("message.rank-user.admin-msg.prefix"),
                        p);
            } else{
    ...
    @Override
    public String info() {
        return "/rango prefix <user> <prefix>";
    }
